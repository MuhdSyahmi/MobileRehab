...
public class PatientProfile extends AppCompatActivity {
    ...
    final String updateUrl = "http://192.168.0.121/MobileRehab/patient.php";
    ...
    private void populateProfile() {
        ...
        final String appointmentUrl = "http://192.168.0.121/MobileRehab/populateprofile.php?user_id=" + user_id;
